...
const scheduleBookingAction = async() => {
    ...
    let bookingAttributes = [
        ...
        'dropOffLocation', 'dropOffLat', 'dropOffLng', 'riderId', 'vehicleType', 'vehicleId', 'vehicleNumber', 
        ...
        for (i in scheduleBookingList) {
            ...
            if (isRiderActiveBooking) {
                ...
                if (nearestDrivers && nearestDrivers.length > 0) { // Drivers Available
                    ...
                    await updateBookingDetails(bookingId, driverId, vehicleData && vehicleData.id, vehicleData && vehicleData.vehicleNumber);
