...
export class InsuranceDropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, change, oldFileName, uploadInsuranceImage } = this.props;
        const fileName = fromServer.fileName;
        await uploadInsuranceImage(id, fileName, oldFileName)
        await change("EditVehicleForm", 'vehicleInsurance', fileName);
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerInsurance',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadInsuranceImage'
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerInsurance')}>
...
export default withStyles(s)(connect(mapState, mapDispatch)(InsuranceDropzone));
