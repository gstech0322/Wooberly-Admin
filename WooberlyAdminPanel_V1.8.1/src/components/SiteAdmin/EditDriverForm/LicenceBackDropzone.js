...
export class LicenceBackDropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, change, uploadLicenceBackImage, oldImageBack } = this.props;
        const licenceBack = fromServer.fileName;
        await uploadLicenceBackImage(id, licenceBack, oldImageBack)
        await change('EditDriverForm', 'licenceBack', licenceBack) 
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerLicenceBack',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerLicenceBack')}>
...
export default withStyles(s)(connect(mapState, mapDispatch)(LicenceBackDropzone));
