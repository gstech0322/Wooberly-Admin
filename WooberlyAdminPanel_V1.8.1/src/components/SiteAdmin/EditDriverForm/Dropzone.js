...
export class Dropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, change, oldFileName, uploadProfileImage, fieldName } = this.props;
        const fileName = fromServer.fileName;
        uploadProfileImage(id, fileName, oldFileName)
        await change("EditDriverForm", fieldName, fileName);   
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerProfilePicture',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadProfileImage'
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerProfilePicture')}>
