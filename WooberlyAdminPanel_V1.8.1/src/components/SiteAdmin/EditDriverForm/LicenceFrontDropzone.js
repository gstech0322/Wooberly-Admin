...
export class LicenceFrontDropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, change, uploadLicenceFrontImage, oldImageFront } = this.props;
        const licenceFront = fromServer.fileName;
        await uploadLicenceFrontImage(id, licenceFront, oldImageFront)
        await change("EditDriverForm", 'licenceFront', licenceFront);
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerLicenceFront',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadLicenceImage'
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerLicenceFront')}>
...
export default withStyles(s)(connect(mapState, mapDispatch)(LicenceFrontDropzone));
