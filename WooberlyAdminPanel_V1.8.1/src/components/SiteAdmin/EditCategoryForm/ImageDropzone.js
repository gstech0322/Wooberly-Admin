...
export class ImageDropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, updateCategoryImage, change, oldFileName } = this.props;
            
        const fileName = fromServer.fileName;

        await updateCategoryImage(id, fileName, oldFileName);
        await change("EditCategoryForm", 'categoryImage', fileName);
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerIcon',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadCategoryImage'
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerIcon')}>
...
const mapDispatch = { updateCategoryImage, change };

export default withStyles(s)(connect(mapState, mapDispatch)(ImageDropzone));
