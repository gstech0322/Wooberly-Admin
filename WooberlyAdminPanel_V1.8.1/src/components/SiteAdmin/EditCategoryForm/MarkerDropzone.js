...
export class MarkerDropzone extends Component {
    ...
    async success(file, fromServer) {
        const { id, updateCategoryMarker, change, oldFileNameValue } = this.props;
        const fileName = fromServer.fileName;

        await updateCategoryMarker(id, fileName, oldFileNameValue);

        await change("EditCategoryForm", 'categoryMarkerImage', fileName);
    }
    ...
    render() {
        ...
        const djsConfig = {
            ...
            hiddenInputContainer: '.dzInputContainerMarker',
            timeout: 300000
            // maxFiles: 1
        };
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadCategoryMarker'
        };
        ...
        return (
            <div className={cx('listPhotoContainer')}>
                <div className={cx('dzInputContainerMarker')}>
...
const mapDispatch = { updateCategoryMarker, change };

export default withStyles(s)(connect(mapState, mapDispatch)(MarkerDropzone));
