...
export class LogoDropzone extends Component {
    ...
    async success(file, fromServer) {
        ...
        await updateTempImages('SiteSettings', 'siteLogo', fileName);
    }
    ...
    render() {
        ...
        var componentConfig = {
            ...
            postUrl: apiEndpoint + '/uploadLogoImage'
        };
...
export default withStyles(s)(connect(mapState, mapDispatch)(LogoDropzone));
